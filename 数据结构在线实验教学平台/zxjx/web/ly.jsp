		...
		<div class="rlist">
			<table width="100%" border="0" align="left" cellpadding="4" cellspacing="0" class="rtable">
				...
				<tr class="tr1">
					...
					<td class="rldate daslist">留言内容</td>
					<td class="rldate daslist">时间</td>
					<td class="rldate daslist">回复内容</td>
					<td class="rldate daslist">回复人</td>
					<td class="rldate daslist">回复时间</td>
				</tr>
<%
...
<%
 if(member!=null){ %>
			<div class="rlist">
				<FORM name="form1" method="post" action="<%=basePath %>ly/addMethod" >
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="0" class="rtable">
						<tbody>
						<tr class="tr1">
							<td class="rldatee daslist">用户：</td>
							<td class="rltitle dotlist"><%=member %></td>
						</tr>
						<tr class="tr1">
							<td class="rldatee daslist">留言内容：</td>
							<td class="rltitle dotlist"><textarea name="nr" cols="50" rows="6" required></textarea></td>
						</tr>
						<tr class="tr1">
							<td class="rldatee daslist"></td>
							<td class="rltitle daslist"><input type="submit" value="提交留言" style="width:80px;" /></td>
						</tr>
						</tbody>
					</table>
				</FORM>
			</div>
			<%}else{out.println("<p align=center>请先登录！");} %>
		</div>
	</div>
</div>

...
<%
	...
	if(username==null){
		...
		String id="";String bt="";String nr=""; String fl="";
...
<div class="right_cont">
    ...
    <div style="width:900px;margin:auto;">
        <form action="<%=basePath %>xw/addMethod" method="post" name="form1">
            <table class="table table-bordered">
                ...
                <tr>
                    <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">信息来源：</td>

...
String message = (String)request.getAttribute("message");
	...
	if(username==null){
		...
		String id="";
		String usernam="";String password="";String realname="";String sex="";String age="";String tel="";String address="";
...
<form action="<%=basePath %>admin/addAdmin?method=<%=method%>&id=<%=id%>" method="post" name="form1">
<table class="table table-bordered">
	 <tr>
     <td width="40%" align="right" nowrap="nowrap" bgcolor="#f1f1f1">登录帐号：</td>
     <td><input type="text" name="username" class="span4" value="<%=usernam %>" required/> </td>
     </tr>
     <tr>
     ...
     <td><input type="number" min="18" max="100" name="age" class="span4" value="<%=age %>" required/></td>
     </tr>
     <tr>

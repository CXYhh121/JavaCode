...
<%  String word= request.getParameter("word");
	...
	int cou = cb.getMessageCount("select count(*) from admin where username like '%"+word+"%' and  sf!='管理员'");//得到信息总数
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from admin where username like '%"+word+"%' and  sf!='管理员' order by id desc",9);
...
%>
       <tr align="center">
           ...
           <td nowrap="nowrap"><a href="<%=basePath%>admin/system/add.jsp?method=upm&id=<%=pagelist2.get(0).toString()%>">修改</a>
               <a href="<%=basePath%>admin/del/<%=pagelist2.get(0).toString()%>">删除</a></td>
       </tr>
<% } %>
       <tr align="center">

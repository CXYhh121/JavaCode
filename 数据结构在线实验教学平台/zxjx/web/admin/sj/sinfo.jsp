        ...
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                ...
                <%
                    ...
                    int cou = cb.getMessageCount("select count(*) from sj where mc like '%"+word+"%' and js='"+admin+"'");//得到信息总数
                    ...
                    List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from sj where mc like '%"+word+"%' and js='"+admin+"' order by id desc",8);

...
function top2(){
   	form3.action="<%=basePath%>admin/ly/sinfo.jsp?page=1";
    form3.submit();
}
function last2(){
	...
	form3.action="<%=basePath%>admin/ly/sinfo.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre2(){
    ...
    alert("已至第一页");
        ...
        form3.action="<%=basePath%>admin/ly/sinfo.jsp?page="+(page-1);
        form3.submit();
    }
}
...
function bjump2(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="<%=basePath%>admin/ly/sinfo.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="<%=basePath%>admin/ly/sinfo.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="<%=basePath%>admin/ly/sinfo.jsp?page="+page;
      form3.submit();
        ...
        <form action="" method="post" name="form3">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr align="center">
                    ...
                    <td nowrap="nowrap"><strong>内容</strong></td>
                    <td nowrap="nowrap"><strong>时间</strong></td>
                    <td nowrap="nowrap"><strong>回复信息</strong></td>
                    <td nowrap="nowrap"><strong>回复人</strong></td>
                    <td nowrap="nowrap"><strong>回复时间</strong></td>
                    <td width="80" nowrap="nowrap"><strong>操作</strong></td>
                </tr>
<%String word= (request.getParameter("word"));
	cb.setEVERYPAGENUM(12);
	int cou = cb.getMessageCount("select count(*) from ly where member like '%"+word+"%' or nr like '%"+word+"%'");//得到信息总数			        
	...
	List pagelist1 = cb.getMessage(Integer.parseInt(page1),"select * from ly where member like '%"+word+"%' or nr like '%"+word+"%' order by id desc",7);
...
%>
                <tr align="center">
                    ...
                    <td nowrap="nowrap">
                        <a href="<%=basePath%>admin/ly/add.jsp?id=<%=pagelist2.get(0).toString()%>">回复</a>
                        <a href="<%=basePath%>ly/de/<%=pagelist2.get(0).toString()%>">删除</a>
                    </td>
                </tr>
<% }} %>
                <tr align="center">
